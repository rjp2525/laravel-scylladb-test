...
return [
    ...
    */
    ...
    'driver' => App\AuditDrivers\MicroserviceDriver::class,
    ...
    */
    ...
    'drivers' => [
        'database' => [
            'connection' => env('AUDIT_DB_CONNECTION', 'mariadb'),
            'table' => env('AUDIT_TABLE', 'audits'),
        ],

        'microservice' => [
            'driver' => \App\AuditDrivers\MicroserviceDriver::class,
            'base_url' => env('AUDIT_MICROSERVICE_BASE_URL', 'http://localhost:8080'),
        ],
    ],
